                ...
                <div className="container text-light">
                    <div className="row  border-bottom border-2 pb-4 border-danger py-5">
                        ...
                        <div className="col text-center ">
                            ...
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cum odio corporis obcaecati praesentium facere at dolores, vitae pariatur distinctio est, tenetur facilis fugit? Fugit excepturi, dolorem ab doloremque dolorum sapiente.</p>
                        </div>
                    </div>
