                ...
                <div className="container text-light">
                    <div className="row  border-bottom border-2 pb-4 border-danger py-5">
                        ...
                        <div className="col text-center ">
                            ...
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Distinctio quae adipisci amet odit, doloribus rem at alias? Quod expedita repudiandae magnam, placeat sunt facere recusandae fuga corporis maxime dignissimos iste.</p>
                        </div>
                    </div>
